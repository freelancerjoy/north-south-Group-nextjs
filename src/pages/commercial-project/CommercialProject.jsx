...
import heroImage from "../../assets/images/realEstateImg3.jpg";
import extImg1 from "../../assets/images/realEstateImg1.jpg";
import extImg2 from "../../assets/images/realEstateImg2.jpg";
...
/* ---------------------------------------------------------
   ...
   Brand Green : #006253 (Logo's Primary Dark Green - for elegant blocks)
   Brand Olive : #9EBC3A (Logo's Secondary Green - for glowing accents)
----------------------------------------------------------- */
...
const SunArc = () => (
  <svg viewBox="0 0 600 200" className="w-full max-w-2xl mx-auto" fill="none">
    ...
    <text x="300" y="70" textAnchor="middle" className="font-tech" fill="#9EBC3A" fontSize="12" letterSpacing="2">ZENITH</text>
...
const CommercialProject = () => {
  ...
  const galleryImages = [
    { src: heroImage, title: "Exterior View" },
    { src: fallbackImage, title: "Modern Lobby" },
    { src: extImg1, title: "Office Space" },
    { src: extImg2, title: "Conference Hall" },
    { src: heroImage, title: "Night View" },
  ];
  ...
  const specs = [
    ["Land Area", "45 Katha"], ["Built-up Area", "500,000 Sq. Ft."],
    ["Total Floors", "3B + G + 24F"], ["Commercial Units", "120 Offices"],
    ["Retail Spaces", "3 Floors"], ["Parking", "400+ Cars"],
    ["Elevators", "8 High-Speed"], ["Completion", "Q4 2028"],
  ];
    ...
    <div className="bg-[#0A0A0A] min-h-screen text-[#F5F0E6] overflow-x-hidden pt-[72px]">
      ...
      <section ref={heroRef} className="relative h-screen min-h-[640px] overflow-hidden">
        <motion.div style={{ scale: heroScale }} className="absolute inset-0 z-0">
          <img src={heroImage} alt="Commercial Project Hero" className="w-full h-full object-cover" />
        ...
        <div className="absolute top-8 left-6 md:left-12 z-10 flex items-center gap-3">
          ...
          <span className="font-tech text-xs tracking-[0.3em] uppercase text-white">Commercial Development</span>
        </div>
        ...
        <motion.div style={{ y: titleY }} className="absolute inset-0 z-10 flex flex-col items-center justify-center text-center px-4">
          ...
          >
            Zenith
            <span className="block text-[#9EBC3A]">Tower</span>
          </motion.h1>
        </motion.div>

        <div className="absolute bottom-0 left-0 right-0 z-10">
          <Marquee text="Downtown BD — 25 Stories — Est. 2028 — Premium Commercial —" />
        </div>
      </section>
      ...
      <section id="overview" className="relative py-28 md:py-36 bg-[#0A0A0A]">
        ...
        <div className="relative max-w-6xl mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-12 gap-12 items-end mb-16">
            <h2 className="lg:col-span-8 font-display uppercase text-4xl md:text-6xl leading-[0.95] text-white">
              A Landmark<br />of Excellence
            </h2>
            <p className="lg:col-span-4 font-body font-light text-[#B8B3A6] leading-relaxed">
              Situated in the heart of the business district, The Zenith Tower offers state-of-the-art commercial spaces designed for forward-thinking enterprises &mdash; setting a new standard for corporate environments.
            </p>
          </div>

          <div className="relative h-[70vh] min-h-[420px] w-full">
            <img src={fallbackImage} alt="Project Overview" className="w-full h-full object-cover" />
            <div className="absolute -bottom-6 -right-6 md:-bottom-10 md:-right-10 bg-[#006253] text-[#F5F0E6] px-8 py-6 md:px-10 md:py-8 shadow-xl">
              <p className="font-display text-3xl md:text-4xl leading-none">Ongoing</p>
              <p className="font-tech text-[#9EBC3A] text-xs uppercase tracking-[0.2em] mt-2">Construction Status</p>
            </div>
          </div>
        </div>
      </section>

      {/* 4. Signature: Zenith arc */}
      <section className="py-24 md:py-32 bg-[#0A0A0A] border-y border-white/10">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <p className="font-tech text-xs uppercase tracking-[0.3em] text-[#9EBC3A] mb-4">The Name</p>
          <h2 className="font-display uppercase text-3xl md:text-4xl text-white mb-2">Why "Zenith"</h2>
          <p className="font-body font-light text-[#9C978C] max-w-xl mx-auto mb-12">
            The zenith is the sun's highest point in the sky &mdash; the peak of light, visibility, and reach. It's the vantage point this tower was built to command.
          </p>
          <SunArc />
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 bg-[#F5F0E6] text-[#0A0A0A]">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex items-end justify-between mb-16 gap-6">
            <h2 className="font-display uppercase text-4xl md:text-6xl leading-none">Unmatched<br />Features</h2>
            <span className="font-tech text-xs uppercase tracking-[0.25em] text-[#8A8578] hidden md:block">Scroll to explore</span>
          </div>
      ...
      <section className="relative bg-[#0A0A0A]">
        <div className="flex flex-col lg:flex-row min-h-[75vh]">
          <div className="lg:w-3/5 relative h-[50vh] lg:h-auto overflow-hidden group">
            <img src={extImg1} alt="Architecture Detail" className="w-full h-full object-cover transition-transform duration-[1400ms] group-hover:scale-105" />
          </div>
          <div className="lg:w-2/5 p-12 lg:p-16 flex flex-col justify-center bg-[#006253] text-[#F5F0E6]">
            <h2 className="font-display uppercase text-3xl lg:text-4xl leading-tight mb-6">Architectural<br />Brilliance</h2>
            <p className="font-body leading-relaxed text-[#F5F0E6]/80">
              The exterior boasts a dynamic geometric design that reflects the sky, creating a visually striking landmark &mdash; with triple-height lobby ceilings and premium finishes.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col-reverse lg:flex-row min-h-[75vh]">
          <div className="lg:w-2/5 p-12 lg:p-16 flex flex-col justify-center border-t lg:border-t-0 border-white/10">
            <h2 className="font-display uppercase text-3xl lg:text-4xl leading-tight mb-6 text-white">Innovative<br />Workspaces</h2>
            <p className="font-body text-[#B8B3A6] font-light leading-relaxed">
              Column-free office floors built for productivity and well-being, with panoramic windows framing breathtaking views of the skyline.
            </p>
          </div>
          <div className="lg:w-3/5 relative h-[50vh] lg:h-auto overflow-hidden group">
            <img src={extImg2} alt="Workspace Layout" className="w-full h-full object-cover transition-transform duration-[1400ms] group-hover:scale-105" />
          </div>
        </div>
      </section>
      ...
      <section id="gallery" className="py-24 md:py-32 bg-[#F5F0E6] text-[#0A0A0A]">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <h2 className="font-display uppercase text-4xl md:text-6xl leading-none mb-16">Project<br />Gallery</h2>
      ...
      <section className="py-24 md:py-32 bg-[#0A0A0A] relative overflow-hidden">
        <div className="max-w-5xl mx-auto px-6 lg:px-12 relative z-10 text-center">
          <h2 className="font-display uppercase text-4xl md:text-6xl text-white mb-6">Experience<br /><span className="text-[#9EBC3A]">The Zenith</span></h2>
          <p className="font-body text-[#9C978C] mb-12 max-w-2xl mx-auto font-light">Watch our cinematic showcase to get a feel for the unparalleled luxury and scale of this development.</p>

          <div className="relative aspect-video bg-black overflow-hidden group cursor-pointer shadow-2xl">
            <img src={heroImage} alt="Video Thumbnail" className="w-full h-full object-cover opacity-50 group-hover:opacity-30 transition-opacity duration-500" />
      ...
      <section className="py-24 md:py-32 bg-[#F5F0E6] text-[#0A0A0A]">
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          <h2 className="font-display uppercase text-4xl md:text-6xl leading-none mb-16">Specifications</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-px bg-[#0A0A0A]/10">
            {specs.map(([label, value]) => (
              <div key={label} className="bg-[#F5F0E6] p-8">
                <p className="font-tech text-xs uppercase tracking-[0.2em] text-[#8A8578] mb-3">{label}</p>
      ...
      <section className="py-24 md:py-32 bg-[#0A0A0A]">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="font-display uppercase text-4xl md:text-5xl leading-none mb-8 text-white">Prime<br />Location</h2>
              <p className="font-body text-[#9C978C] leading-relaxed mb-10 font-light text-lg">
                Centrally located in the premier business district, offering unparalleled convenience for businesses, employees, and clients alike.
              </p>
              <ul className="space-y-4">
                {["5 mins from Central Metro Station", "15 mins from International Airport", "Adjacent to 5-Star Hotels", "Walking distance to Major Banks"].map((item) => (
                  <li key={item} className="flex items-center text-white font-body">
                    <span className="w-2 h-2 bg-[#9EBC3A] mr-4" />
                    <span className="font-light">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
            <div className="h-[420px] bg-[#151515] relative overflow-hidden flex items-center justify-center border border-white/10">
      ...
      <section className="relative bg-[#006253] text-[#F5F0E6] py-28 md:py-40 text-center overflow-hidden">
        <div className="relative z-10 max-w-4xl mx-auto px-6">
          <h2 className="font-display uppercase text-5xl md:text-7xl leading-[0.9] mb-8 text-white">
            Claim Your<br />Space Today
          </h2>
          <p className="font-body text-lg font-light mb-12 max-w-xl mx-auto text-[#F5F0E6]/90">
            Contact our sales team for detailed floor plans, pricing, and availability.
          </p>
        ...
        <Marquee text="Downtown BD — 25 Stories — Est. 2028 — Premium Commercial —" dark />
      </section>
    </div>
  );
};
